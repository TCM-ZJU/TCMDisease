...
<center>
	<table width="800" border="0" class="table2">
        <tr> 
          <td colspan="5" class="title1">符合条件的的疾病记录<%=recordnum%>条，第<%=Cint(intOffset/intPage)+1%>页，共<%=pagenum%>页</td>
        </tr>
        <tr>
			<td><div align="center"><strong>疾病名称</strong></div></td>
			<td width="123"><div align="center"><strong><font size="-1">录入人员</font></strong></div></td>
			<td width="110"><div align="center"><strong><font size="-1">加工单位</font></strong></div></td>
            <td width="118"><div align="center"><strong><font size="-1">状态说明</font></strong></div></td>
