...
<% 
	...
	dim strSQL
	strSQL="select CUSER,PASSWD,EDATE,ENABLED,CLEVEL,slocked from CUser where CUSER='" &  UserName &"'" &" and Passwd='" & Passwd & "'"
...
<%
				...
				OraDatabase.ExecuteSQL "Update Cuser set slocked='1' where Cuser='" & UserName &"'"
